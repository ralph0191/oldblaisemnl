...
$result=mysqli_query($con,"select * from sales where sale_date like '2018-07-%'");
...
$pdf->SetXY(86,  $pdf->GetY() + 55); // position of text1, numerical, of course, not x1 and y1
$pdf->Write(0, 'July Sales');
