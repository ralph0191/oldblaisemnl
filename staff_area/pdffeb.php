...
$result=mysqli_query($con,"select * from sales where sale_date like '2018-02-%'");
...
$pdf->SetX(10);
$pdf->SetX(90);
$pdf->MultiCell(100,6,''.'Sales Total:'.$total,1,'C');
