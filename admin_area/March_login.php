...
#sa a:hover {text-decoration:underline; font-weight:bolder; color:orange;}
 ...
 <div id="sa">
		...
		<center>
		<br><hr></center>
		<a href='pdfmarch.php' target="_blank">Print PDF</a>
...
<table cellspacing="4">
<tr align="center">
		<td colspan="6"><h2>Staff/Admin Logs</h2></td>
	</tr>
...
<?php 	
	$get_pro = "select * from loginlogs where logintime like '2018-03-%' ORDER BY logintime DESC";
