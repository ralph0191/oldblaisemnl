...
<!--Content starts here-->
		...
		<div id="welcome">
			<h2>Welcome</h2><br>
			<p>
				 The Secret Sevice.CO is a retailer of premium hand crafted & designed apparel by Ms.Angela Chavez
			</p>
		</div>
		<div id="image"></div>
...
Address: #109 Doberman ave. Makati City<br>
Phone: +811 808 80
</address></p>
			
	  </div>
<div id="get-in-touch">
<h3>How's our site?</h3>
	  <ul id="contact-list">
