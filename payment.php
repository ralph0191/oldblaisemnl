...
<h2 align="center" style="padding:2px;">Pay now with Paypal:</h2>
 ...
 <form action="https://www.sandbox.paypal.com/webapps/hermes?token=7CH67092776521716&useraction=commit&mfid=1487253063304_e14f97d839ff#/checkout/review" method="post">

  <!-- Identify your business so that you can collect the payments. -->
  <input type="hidden" name="business" value="banchihuehue@gmail.com">
...
<input type="hidden" name="cancel_return" value="midterms/customer/paypal_cancel.php"/>
